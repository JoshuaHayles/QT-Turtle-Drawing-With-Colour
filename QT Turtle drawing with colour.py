...
class TurtleControl(QWidget): 
    def __init__(self, turtle):
        ...
        #Defining the buttons I want on the control panel 
        ...
        #Defining the spin boxes I want on the control panel
        ...
        self.controlsLayout.addWidget(self.red_spin,2 , 0)
        self.controlsLayout.addWidget(self.red_label,2 , 1)
        self.controlsLayout.addWidget(self.green_spin,3 , 0)
        self.controlsLayout.addWidget(self.green_label,3 , 1)
        self.controlsLayout.addWidget(self.blue_spin,4 , 0)
        self.controlsLayout.addWidget(self.blue_label,4 , 1)
        self.controlsLayout.addWidget(self.colour_btn,5, 0)
        self.setLayout(self.controlsLayout)
        
        #MaxMin values of distance spin box
        self.distance_spin.setRange(0, 100)
        #How much spin box moves when you click it
        self.distance_spin.setSingleStep(5)
        #Number spin box starts on
        self.distance_spin.setValue(20)
        
        #Controlling the colour spin boxes
    ...
    def colour_turtle(self):
        self.turtle.colour(self.red_spin.value(),
                    self.green_spin.value(),
                    self.blue_spin.value())
    def colour_turtle(self):
        self.colour = QColorDialog.getColor()
        self.turtle.color(self.colourgetRgb()[:3])
